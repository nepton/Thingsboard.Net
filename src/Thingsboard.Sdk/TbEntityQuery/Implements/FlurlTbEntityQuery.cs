...
{
    public FlurlTbEntityQuery(IAccessTokenCaching accessTokenStorage, IOptionsSnapshot<ThingsboardSdkOptions> options) : base(accessTokenStorage, options)
    {
    }
