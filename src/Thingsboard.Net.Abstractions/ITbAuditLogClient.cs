...
/// <summary>
/// Represents a client for interacting with the Thingsboard REST API with audit log support.
/// </summary>
public interface ITbAuditLogClient : ITbClient<ITbAuditLogClient>
{
    /// <summary>
    ...
    /// <param name="cancel"></param>
    /// <returns></returns>
    Task<TbPage<TbAudit>> GetAuditLogsByCustomerIdAsync(
        Guid                         customerId,
        int                          pageSize,
        int                          page,
        string?                      textSearch   = null,
    ...
    /// <param name="cancel"></param>
    /// <returns></returns>
    Task<TbPage<TbAudit>> GetAuditLogsByEntityIdAsync(
    ...
    /// <param name="cancel"></param>
    /// <returns></returns>
    Task<TbPage<TbAudit>> GetAuditLogsByUserIdAsync(
        Guid                         userId,
        int                          pageSize,
        int                          page,
        string?                      textSearch   = null,
